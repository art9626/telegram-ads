...
if (import.meta.env.DEV) {
  ...
  if (shouldMock) {
    ...
    // TODO:
    // Attempt to load banner without user data.
    // If your dev server uses browser environment, you should mock window.Telegram.WebApp.initDataUnsafe.user.id.
    // Be aware, some alerts/confirms won't be showed in browser
    console.info(
